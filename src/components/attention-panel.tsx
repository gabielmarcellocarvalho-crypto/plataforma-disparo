...
export function AttentionPanel({ contacts }: { contacts: AttentionContact[] }) {
  ...
  return (
    <div className="bg-surface border border-danger/20 rounded-lg shadow-sm p-5 flex flex-col gap-3">
      <div className="flex items-center gap-2">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-danger" aria-hidden>
