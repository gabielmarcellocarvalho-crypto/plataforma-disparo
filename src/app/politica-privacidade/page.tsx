    ...
    <main className="min-h-full bg-bg">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 flex flex-col gap-10">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-text-muted">Última atualização: {ATUALIZADO_EM}</p>
        </div>
        ...
        <Secao titulo="1. Quem somos">
          ...
          <p>
            ...
            <strong className="text-text">gabrielcarvalho@v4company.com</strong>.
          </p>
        </Secao>
